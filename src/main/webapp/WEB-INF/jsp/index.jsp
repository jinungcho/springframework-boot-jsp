    ...
    <body>
        ...
        <div id="home" class="section intro-page">
            <div class="block content-1170 center-relative center-text">
                ...
                <br>
                <h1 class="big-title">조진웅 <span>Developer</span></h1>
                <p class="title-desc">@CURONSYS</p>
            </div>
        </div>
        ...
        <div id="about" class="section">
            <div class="block content-1170 center-relative">
                <div class="section-title-holder left">
                    ...
                    <h2 class="entry-title">DEVELOPER</h2>
                </div>
                <div class="section-content-holder right">
                    <div class="content-wrapper">
            ...
            <div class="block content-1170 center-relative">
                ...
                <div class="section-content-holder left">
                    <div class="content-wrapper">
                        ...
                        <p>항상 부족하다 생각하고 배워가고있습니다. 최신 기술을 익히되, 공공 SI 사업을 위주로 현행하고 있는 기술들을 기초부터 다져가며 일하고있습니다.</p>
                        <br>
                        <div class="progress_bar ">
                            <div class="progress_bar_field_holder" style="width:81%;">
                                <div class="progress_bar_title" style="color: #55B286">jQuery</div>
                        ...
                        <div class="progress_bar ">
                            <div class="progress_bar_field_holder" style="width:66%;">
                                <div class="progress_bar_title" style="color: #8700ca">Node.js</div>
                                <div class="progress_bar_percent_text" style="color: #8700ca">66%</div>
                                <div class="progress_bar_field_perecent" style="background-color:#ac00ca;"></div>
                            </div>
                        </div>
                        <div class="progress_bar ">
                            <div class="progress_bar_field_holder" style="width:73%;">
                                <div class="progress_bar_title" style="color: #E3A536">Java</div>
                                <div class="progress_bar_percent_text" style="color: #E3A536">73%</div>
                                <div class="progress_bar_field_perecent" style="background-color:#FFBB42;"></div>
                            </div>
                        </div>
                        <div class="progress_bar ">
                            <div class="progress_bar_field_holder" style="width:52%;">
                                <div class="progress_bar_title" style="color: #B24564">Spring/Egov</div>
                                <div class="progress_bar_percent_text" style="color: #B24564">52%</div>
                                <div class="progress_bar_field_perecent" style="background-color:#E74C78;"></div>
                            </div>
                        </div>
                        <div class="progress_bar ">
                            <div class="progress_bar_field_holder" style="width:36%;">
                                <div class="progress_bar_title" style="color: #468ac7">SQL</div>
                                <div class="progress_bar_percent_text" style="color: #468ac7">36%</div>
